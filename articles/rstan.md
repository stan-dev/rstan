...
```
    ...
    Samples were drawn using NUTS(diag_e) at Wed Dec 10 00:36:39 2025.
...
[`help("stanfit", "rstan")`](https://mc-stan.org/rstan/reference/stanfit-class.md).
...
available plots. See
[`help("plot,stanfit-method")`](https://mc-stan.org/rstan/reference/stanfit-method-plot.md).
