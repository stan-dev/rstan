...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model25357e76e429_external_namespace::model25357e76e429_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.5.2/lib/R/etc/Makeconf:211: file25353b8547e0.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model2535699dd41d_file25356b9747a8_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file25356b9747a8', line 2, column 19 to column 45)"};
    ## class model2535699dd41d_file25356b9747a8 final : public model_base_crtp<model2535699dd41d_file25356b9747a8> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model2535699dd41d_file25356b9747a8() {}
    ##   model2535699dd41d_file25356b9747a8(stan::io::var_context& context__,
