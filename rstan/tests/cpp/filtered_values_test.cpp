...
public:
  ...
  void SetUp() { 
    ...
    writer_ptr = new rstan::filtered_values
  ...
  int N;
  int M;
  rstan::filtered_values<std::vector<double> > *writer_ptr;
  std::vector<std::vector<double> > preallocated_values;
  std::vector<size_t> filter;
};

TEST_F(RStan, filtered_values_vector_double) {
...
TEST_F(RStan, filtered_values_vector_string) {
  rstan::filtered_values<std::vector<double> > 
    writer = *writer_ptr;
...
TEST_F(RStan, filtered_values_string) {
  rstan::filtered_values<std::vector<double> > 
    writer = *writer_ptr;
...
TEST_F(RStan, filtered_values_noargs) {
  rstan::filtered_values<std::vector<double> > 
    writer = *writer_ptr;
