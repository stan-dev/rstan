...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ctsmgen");
    reader.add_event(915, 913, "end", "model_ctsmgen");
    return reader;
}
    ...
    try {
        ...
        for (int coli = 1; coli <= cols(mat); ++coli) {
            ...
            for (int rowi = coli; rowi <= rows(mat); ++rowi) {
                ...
                if (as_bool(is_nan(get_base1(out,rowi,coli,"out",1)))) {
                    ...
                    if (as_bool(logical_neq(rowi,coli))) {
...
class model_ctsmgen : public prob_grad {
private:
    int ndatapoints;
    int nmanifest;
    int nlatent;
...
public:
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.push_back(ll);
            ...
            vector<Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> > Ygen(ndatapoints, (Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> (static_cast<Eigen::VectorXd::Index>(nmanifest))));
            stan::math::initialize(Ygen, DUMMY_VAR__);
            ...
            vector<Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> > Ygenbase(ndatapoints, (Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> (static_cast<Eigen::VectorXd::Index>(nmanifest))));
            stan::math::initialize(Ygenbase, DUMMY_VAR__);
            stan::math::fill(Ygenbase,DUMMY_VAR__);


            current_statement_begin__ = 430;
            stan::math::assign(Ygen, rep_array(rep_vector(99999,nmanifest),ndatapoints));
            current_statement_begin__ = 431;
            for (int mi = 1; mi <= nmanifest; ++mi) {

                current_statement_begin__ = 432;
                if (as_bool((primitive_value(logical_eq(get_base1(manifesttype,mi,"manifesttype",1),0)) || primitive_value(logical_eq(get_base1(manifesttype,mi,"manifesttype",1),2))))) {

                    current_statement_begin__ = 433;
                    stan::model::assign(Ygenbase, 
                                stan::model::cons_list(stan::model::index_min_max(1, ndatapoints), stan::model::cons_list(stan::model::index_uni(mi), stan::model::nil_index_list())), 
                                normal_rng(rep_vector(0,ndatapoints),rep_vector(1,ndatapoints), base_rng__), 
                                "assigning variable Ygenbase");
                }
                current_statement_begin__ = 435;
                if (as_bool(logical_eq(get_base1(manifesttype,mi,"manifesttype",1),1))) {

                    current_statement_begin__ = 436;
                    stan::model::assign(Ygenbase, 
                                stan::model::cons_list(stan::model::index_min_max(1, ndatapoints), stan::model::cons_list(stan::model::index_uni(mi), stan::model::nil_index_list())), 
                                uniform_rng(rep_vector(0,ndatapoints),rep_vector(1,ndatapoints), base_rng__), 
                                "assigning variable Ygenbase");
                }
            }
            {
            ...
            for (int rowi = 1; rowi <= (dokalman ? ndatapoints : 1 ); ++rowi) {
                ...
                if (as_bool(logical_eq(get_base1(dokalmanrows,rowi,"dokalmanrows",1),1))) {
                    ...
                    if (as_bool(logical_gt(get_base1(nobs_y,rowi,"nobs_y",1),0))) {
                        ...
                        int skipupd(0);
                        (void) skipupd;  // dummy to suppress unused var warning

                        stan::math::fill(skipupd, std::numeric_limits<int>::min());
                        stan::math::assign(skipupd,0);


                        current_statement_begin__ = 858;
                        for (int vi = 1; vi <= get_base1(nobs_y,rowi,"nobs_y",1); ++vi) {

                            current_statement_begin__ = 859;
                            if (as_bool((primitive_value((primitive_value(logical_gt(stan::math::fabs(get_base1(ypred,get_base1(o,vi,"o",1),"ypred",1)),10000000000.0)) || primitive_value(is_nan(get_base1(ypred,get_base1(o,vi,"o",1),"ypred",1))))) || primitive_value(is_inf(get_base1(ypred,get_base1(o,vi,"o",1),"ypred",1)))))) {

                                current_statement_begin__ = 860;
                                stan::math::assign(skipupd, 1);
                                current_statement_begin__ = 861;
                                stan::model::assign(ypred, 
                                            stan::model::cons_list(stan::model::index_uni(get_base1(o,vi,"o",1)), stan::model::nil_index_list()), 
                                            99999, 
                                            "assigning variable ypred");
                                ...
                                if (as_bool(logical_gt(verbose,1))) {
                                    current_statement_begin__ = 862;
                                    if (pstream__) {
                                        stan_print(pstream__,"pp ypred problem! row ");
                                        stan_print(pstream__,rowi);
                                        *pstream__ << std::endl;
                                    }
                                }
                        ...
                        if (as_bool(logical_eq(skipupd,0))) {
                            ...
                            if (as_bool(logical_gt(get_base1(ncont_y,rowi,"ncont_y",1),0))) {
                                ...
                                stan::model::assign(Ygen, 
                                            ...
                                            add(stan::model::rvalue(ypred, stan::model::cons_list(stan::model::index_multi(o0), stan::model::nil_index_list()), "ypred"),multiply(stan::model::rvalue(ypredcov_sqrt, stan::model::cons_list(stan::model::index_multi(o0), stan::model::cons_list(stan::model::index_multi(o0), stan::model::nil_index_list())), "ypredcov_sqrt"),stan::model::rvalue(Ygenbase, stan::model::cons_list(stan::model::index_uni(rowi), stan::model::cons_list(stan::model::index_multi(o0), stan::model::nil_index_list())), "Ygenbase"))), 
                            ...
                            if (as_bool(logical_gt(get_base1(nbinary_y,rowi,"nbinary_y",1),0))) {
                                ...
                                for (int obsi = 1; obsi <= size(o1); ++obsi) {
                                    current_statement_begin__ = 868;
                                    stan::model::assign(Ygen, 
                                                stan::model::cons_list(stan::model::index_uni(rowi), stan::model::cons_list(stan::model::index_uni(get_base1(o1,obsi,"o1",1)), stan::model::nil_index_list())), 
                                                (logical_gt(get_base1(ypred,get_base1(o1,obsi,"o1",1),"ypred",1),get_base1(get_base1(Ygenbase,rowi,"Ygenbase",1),get_base1(o1,obsi,"o1",1),"Ygenbase",2)) ? 1 : 0 ), 
                                                "assigning variable Ygen");
                                }
                            }
                            ...
                            for (int vi = 1; vi <= get_base1(nobs_y,rowi,"nobs_y",1); ++vi) {
                                current_statement_begin__ = 869;
                                if (as_bool(is_nan(get_base1(get_base1(Ygen,rowi,"Ygen",1),get_base1(o,vi,"o",1),"Ygen",2)))) {

                                    current_statement_begin__ = 870;
                                    stan::model::assign(Ygen, 
                                                stan::model::cons_list(stan::model::index_uni(rowi), stan::model::cons_list(stan::model::index_uni(get_base1(o,vi,"o",1)), stan::model::nil_index_list())), 
                                                99999, 
                                                "assigning variable Ygen");
                            ...
                            if (as_bool(logical_eq(nlmeasurement,0))) {
                                ...
                                if (as_bool(logical_eq(intoverstates,1))) {
                                    ...
                                    for (int wi = 1; wi <= nmanifest; ++wi) {
                                        ...
                                        if (as_bool((primitive_value(logical_gt(get_base1(manifesttype,wi,"manifesttype",1),0)) && primitive_value(logical_neq(get_base1(get_base1(Y,rowi,"Y",1),wi,"Y",2),99999))))) {
                                            current_statement_begin__ = 876;
                                            stan::model::assign(Ygen, 
                                                        stan::model::cons_list(stan::model::index_uni(rowi), stan::model::cons_list(stan::model::index_uni(wi), stan::model::nil_index_list())), 
                                                        stan::model::deep_copy(stan::math::round(get_base1(get_base1(Ygen,rowi,"Ygen",1),wi,"Ygen",2))), 
                                                        "assigning variable Ygen");
                                        }
                                    }
                                }
                            ...
                            stan::model::assign(err, 
                                        stan::model::cons_list(stan::model::index_multi(o), stan::model::nil_index_list()), 
                                        subtract(stan::model::rvalue(Ygen, stan::model::cons_list(stan::model::index_uni(rowi), stan::model::cons_list(stan::model::index_multi(o), stan::model::nil_index_list())), "Ygen"),stan::model::rvalue(ypred, stan::model::cons_list(stan::model::index_multi(o), stan::model::nil_index_list()), "ypred")), 
            ...
            for (int k_1__ = 0; k_1__ < nmanifest; ++k_1__) {
                for (int k_0__ = 0; k_0__ < ndatapoints; ++k_0__) {
                vars__.push_back(Ygen[k_0__][k_1__]);
                }
            }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_1__ = 1; k_1__ <= nmanifest; ++k_1__) {
            for (int k_0__ = 1; k_0__ <= ndatapoints; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "Ygen" << '.' << k_0__ << '.' << k_1__;
                param_names__.push_back(param_name_stream__.str());
            }
        }
    }
...
typedef model_ctsmgen_namespace::model_ctsmgen stan_model;
