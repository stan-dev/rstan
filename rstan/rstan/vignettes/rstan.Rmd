...
laptops. We typicalyl recommend first calling 
...
in the manual.
* The [__shinystan__](https://cran.r-project.org/web/packages/loo/index.html) R
...
* The [__rstanarm__](https://cran.r-project.org/web/packages/rstanarm/index.html) R
