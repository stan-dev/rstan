...
*   checking tests ...
    ...
    Running the tests in ‘tests/testthat.R’ failed.
    Last 13 lines of output:
      ── Error (test-model.R:16:3): stan model availability check ────────────────────
      Error: trying to get slot "mode" from an object of a basic class ("NULL") with no slots
      Backtrace:
          █
       1. └─IgGeneUsage::DGU(...) test-model.R:16:2
       2.   ├─rstan::sampling(...)
       3.   └─rstan::sampling(...)
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ══ Failed tests ════════════════════════════════════════════════════════════════
      ── Error (test_anpl.R:177:3): Adaptive non-parametric learning with posterior samples works ──
