...
*   checking tests ...
    ...
    Running the tests in ‘tests/testthat.R’ failed.
    Last 13 lines of output:
      Chain 4:                2.431 seconds (Sampling)
      Chain 4:                8.934 seconds (Total)
      Chain 4: 
