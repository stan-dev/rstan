...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model28263ed62c43_external_namespace::model28263ed62c43_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.5.2/lib/R/etc/Makeconf:211: file28262a876c29.o] Error 1
...
```
    ...
    ## #define USE_STANC3
    ## #endif
    ## // Code generated by stanc v2.38.0-77-g002979f
    ## #include <stan/model/model_header.hpp>
    ## namespace model2826683a4d2e_file282656bd07b8_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file282656bd07b8', line 2, column 19 to column 45)"};
    ## class model2826683a4d2e_file282656bd07b8 final : public model_base_crtp<model2826683a4d2e_file282656bd07b8> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model2826683a4d2e_file282656bd07b8() {}
    ##   model2826683a4d2e_file282656bd07b8(stan::io::var_context& context__,
