...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model285b6f7dc790_external_namespace::model285b6f7dc790_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.5.3/lib/R/etc/Makeconf:211: file285b12c82e51.o] Error 1
...
```
    ...
    ## #define USE_STANC3
    ## #endif
    ## // Code generated by stanc v2.38.0-97-gd9e4aa6
    ## #include <stan/model/model_header.hpp>
    ## namespace model285b5f07dcb0_file285b6779cbb9_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file285b6779cbb9', line 2, column 19 to column 45)"};
    ## class model285b5f07dcb0_file285b6779cbb9 final : public model_base_crtp<model285b5f07dcb0_file285b6779cbb9> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model285b5f07dcb0_file285b6779cbb9() {}
    ##   model285b5f07dcb0_file285b6779cbb9(stan::io::var_context& context__,
