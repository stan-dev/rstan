...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model26cc7cc45c62_external_namespace::model26cc7cc45c62_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.1/lib/R/etc/Makeconf:199: file26cc15e9bc4c.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model26cc32fedbe4_file26cc78d646ae_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file26cc78d646ae', line 2, column 19 to column 45)"};
    ## class model26cc32fedbe4_file26cc78d646ae final : public model_base_crtp<model26cc32fedbe4_file26cc78d646ae> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model26cc32fedbe4_file26cc78d646ae() {}
    ##   model26cc32fedbe4_file26cc78d646ae(stan::io::var_context& context__,
