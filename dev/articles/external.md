...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model27fc112dc3c8_external_namespace::model27fc112dc3c8_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.5.3/lib/R/etc/Makeconf:211: file27fc468ed956.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model27fc13092941_file27fc3f5f97de_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file27fc3f5f97de', line 2, column 19 to column 45)"};
    ## class model27fc13092941_file27fc3f5f97de final : public model_base_crtp<model27fc13092941_file27fc3f5f97de> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model27fc13092941_file27fc3f5f97de() {}
    ##   model27fc13092941_file27fc3f5f97de(stan::io::var_context& context__,
