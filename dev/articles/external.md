...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model2a394ced3691_external_namespace::model2a394ced3691_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.5.3/lib/R/etc/Makeconf:211: file2a39333533d.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model2a3967553196_file2a39185b0d7e_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file2a39185b0d7e', line 2, column 19 to column 45)"};
    ## class model2a3967553196_file2a39185b0d7e final : public model_base_crtp<model2a3967553196_file2a39185b0d7e> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model2a3967553196_file2a39185b0d7e() {}
    ##   model2a3967553196_file2a39185b0d7e(stan::io::var_context& context__,
