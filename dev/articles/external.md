...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model269a35a8daa_external_namespace::model269a35a8daa_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.1/lib/R/etc/Makeconf:199: file269a5d632726.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model269a7d5341ce_file269a2fcd9206_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file269a2fcd9206', line 2, column 19 to column 45)"};
    ## class model269a7d5341ce_file269a2fcd9206 final : public model_base_crtp<model269a7d5341ce_file269a2fcd9206> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model269a7d5341ce_file269a2fcd9206() {}
    ##   model269a7d5341ce_file269a2fcd9206(stan::io::var_context& context__,
