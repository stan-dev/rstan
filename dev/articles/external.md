...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model25e068119f76_external_namespace::model25e068119f76_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.0/lib/R/etc/Makeconf:199: file25e0c3fb35f.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model25e0ca4d474_file25e03731c98d_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file25e03731c98d', line 2, column 19 to column 45)"};
    ## class model25e0ca4d474_file25e03731c98d final : public model_base_crtp<model25e0ca4d474_file25e03731c98d> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model25e0ca4d474_file25e03731c98d() {}
    ##   model25e0ca4d474_file25e03731c98d(stan::io::var_context& context__,
