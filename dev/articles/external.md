...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model2592d9fa64_external_namespace::model2592d9fa64_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.1/lib/R/etc/Makeconf:199: file25924bba5a3c.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model25925dbb7a8b_file2592181b864a_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file2592181b864a', line 2, column 19 to column 45)"};
    ## class model25925dbb7a8b_file2592181b864a final : public model_base_crtp<model25925dbb7a8b_file2592181b864a> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model25925dbb7a8b_file2592181b864a() {}
    ##   model25925dbb7a8b_file2592181b864a(stan::io::var_context& context__,
