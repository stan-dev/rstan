...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model26ac1688351e_external_namespace::model26ac1688351e_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.0/lib/R/etc/Makeconf:199: file26ac1382883e.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model26ac19001528_file26ac1b86651e_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file26ac1b86651e', line 2, column 19 to column 45)"};
    ## class model26ac19001528_file26ac1b86651e final : public model_base_crtp<model26ac19001528_file26ac1b86651e> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model26ac19001528_file26ac1b86651e() {}
    ##   model26ac19001528_file26ac1b86651e(stan::io::var_context& context__,
