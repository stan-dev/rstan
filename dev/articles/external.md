...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model2623676ea3aa_external_namespace::model2623676ea3aa_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.1/lib/R/etc/Makeconf:199: file2623763bc134.o] Error 1
...
```
    ...
    ## #define USE_STANC3
    ## #endif
    ## // Code generated by stanc 9247c1d
    ## #include <stan/model/model_header.hpp>
    ## namespace model2623181e5b9_file262368f8339d_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file262368f8339d', line 2, column 19 to column 45)"};
    ## class model2623181e5b9_file262368f8339d final : public model_base_crtp<model2623181e5b9_file262368f8339d> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model2623181e5b9_file262368f8339d() {}
    ##   model2623181e5b9_file262368f8339d(stan::io::var_context& context__,
