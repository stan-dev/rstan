...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model3055159d3a1a_external_namespace::model3055159d3a1a_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.5.2/lib/R/etc/Makeconf:211: file305544889593.o] Error 1
...
```
    ...
    ## #define USE_STANC3
    ## #endif
    ## // Code generated by stanc v2.37.0-172-g8d78669
    ## #include <stan/model/model_header.hpp>
    ## namespace model30558fe5b48_file3055294a79a0_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file3055294a79a0', line 2, column 19 to column 45)"};
    ## class model30558fe5b48_file3055294a79a0 final : public model_base_crtp<model30558fe5b48_file3055294a79a0> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model30558fe5b48_file3055294a79a0() {}
    ##   model30558fe5b48_file3055294a79a0(stan::io::var_context& context__,
