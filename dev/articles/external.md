...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model25344bec6bdc_external_namespace::model25344bec6bdc_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.0/lib/R/etc/Makeconf:199: file2534c024e3e.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model253410db4fd3_file253458a7dde9_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file253458a7dde9', line 2, column 19 to column 45)"};
    ## class model253410db4fd3_file253458a7dde9 final : public model_base_crtp<model253410db4fd3_file253458a7dde9> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model253410db4fd3_file253458a7dde9() {}
    ##   model253410db4fd3_file253458a7dde9(stan::io::var_context& context__,
