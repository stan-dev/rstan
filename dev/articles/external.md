...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model296733d408ea_external_namespace::model296733d408ea_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.5.2/lib/R/etc/Makeconf:211: file2967614b5518.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model296757d8ac3b_file29671d63d43a_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file29671d63d43a', line 2, column 19 to column 45)"};
    ## class model296757d8ac3b_file29671d63d43a final : public model_base_crtp<model296757d8ac3b_file29671d63d43a> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model296757d8ac3b_file29671d63d43a() {}
    ##   model296757d8ac3b_file29671d63d43a(stan::io::var_context& context__,
