...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model25fb3d5546c5_external_namespace::model25fb3d5546c5_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.0/lib/R/etc/Makeconf:199: file25fb1d8525f9.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model25fb4a9d9524_file25fb5b0f9fc2_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file25fb5b0f9fc2', line 2, column 19 to column 45)"};
    ## class model25fb4a9d9524_file25fb5b0f9fc2 final : public model_base_crtp<model25fb4a9d9524_file25fb5b0f9fc2> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model25fb4a9d9524_file25fb5b0f9fc2() {}
    ##   model25fb4a9d9524_file25fb5b0f9fc2(stan::io::var_context& context__,
