...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model2a1e4368435a_external_namespace::model2a1e4368435a_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.1/lib/R/etc/Makeconf:199: file2a1e375af8f0.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model2a1e38f6e81_file2a1e2346c59a_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file2a1e2346c59a', line 2, column 19 to column 45)"};
    ## class model2a1e38f6e81_file2a1e2346c59a final : public model_base_crtp<model2a1e38f6e81_file2a1e2346c59a> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model2a1e38f6e81_file2a1e2346c59a() {}
    ##   model2a1e38f6e81_file2a1e2346c59a(stan::io::var_context& context__,
