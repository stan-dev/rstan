...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model24c34b4094a_external_namespace::model24c34b4094a_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.1/lib/R/etc/Makeconf:199: file24c3260840aa.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model24c353b31b89_file24c346d211a4_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file24c346d211a4', line 2, column 19 to column 45)"};
    ## class model24c353b31b89_file24c346d211a4 final : public model_base_crtp<model24c353b31b89_file24c346d211a4> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model24c353b31b89_file24c346d211a4() {}
    ##   model24c353b31b89_file24c346d211a4(stan::io::var_context& context__,
