...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model29014c219af9_external_namespace::model29014c219af9_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.5.3/lib/R/etc/Makeconf:211: file29016d3858ca.o] Error 1
...
```
    ...
    ## #define USE_STANC3
    ## #endif
    ## // Code generated by stanc v2.38.0-89-g5d63971
    ## #include <stan/model/model_header.hpp>
    ## namespace model29011c5d0e2f_file29012a153147_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file29012a153147', line 2, column 19 to column 45)"};
    ## class model29011c5d0e2f_file29012a153147 final : public model_base_crtp<model29011c5d0e2f_file29012a153147> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model29011c5d0e2f_file29012a153147() {}
    ##   model29011c5d0e2f_file29012a153147(stan::io::var_context& context__,
