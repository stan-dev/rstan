...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model274e426204ec_external_namespace::model274e426204ec_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.5.2/lib/R/etc/Makeconf:211: file274e11da5ede.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model274e74d3a19e_file274e1991a89a_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file274e1991a89a', line 2, column 19 to column 45)"};
    ## class model274e74d3a19e_file274e1991a89a final : public model_base_crtp<model274e74d3a19e_file274e1991a89a> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model274e74d3a19e_file274e1991a89a() {}
    ##   model274e74d3a19e_file274e1991a89a(stan::io::var_context& context__,
