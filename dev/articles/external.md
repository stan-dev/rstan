...
```
    ...
    ## ! 1>; int Option = 0; Scalar = double]’
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model2829c7216a5_external_namespace::model2829c7216a5_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.5.2/lib/R/etc/Makeconf:211: file282999a5a85.o] Error 1
...
```
    ...
    ## Warning in file(con, "r"): expanded path length 13627 would be too long for
    ## #ifndef USE_STANC3
    ## #define USE_STANC3
    ## #endif
    ## // Code generated by stanc v2.38.0-9-g7ba3f25
    ## #include <stan/model/model_header.hpp>
    ## namespace model282924dcd85b_file2829ef8b3cd_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file2829ef8b3cd', line 2, column 19 to column 45)"};
    ## class model282924dcd85b_file2829ef8b3cd final : public model_base_crtp<model282924dcd85b_file2829ef8b3cd> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model282924dcd85b_file2829ef8b3cd() {}
    ##   model282924dcd85b_file2829ef8b3cd(stan::io::var_context& context__,
