...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model268673cc2a09_external_namespace::model268673cc2a09_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.5.2/lib/R/etc/Makeconf:211: file2686606c02bc.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model268620094c60_file2686642134b5_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file2686642134b5', line 2, column 19 to column 45)"};
    ## class model268620094c60_file2686642134b5 final : public model_base_crtp<model268620094c60_file2686642134b5> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model268620094c60_file2686642134b5() {}
    ##   model268620094c60_file2686642134b5(stan::io::var_context& context__,
