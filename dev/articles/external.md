...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model2587418e504_external_namespace::model2587418e504_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.1/lib/R/etc/Makeconf:199: file2587358b5174.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model258731f527ec_file25872681786d_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file25872681786d', line 2, column 19 to column 45)"};
    ## class model258731f527ec_file25872681786d final : public model_base_crtp<model258731f527ec_file25872681786d> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model258731f527ec_file25872681786d() {}
    ##   model258731f527ec_file25872681786d(stan::io::var_context& context__,
