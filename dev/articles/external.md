...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model25597a9c9d68_external_namespace::model25597a9c9d68_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.1/lib/R/etc/Makeconf:199: file25591f6df9ee.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model25596527fdee_file25595ad40336_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file25595ad40336', line 2, column 19 to column 45)"};
    ## class model25596527fdee_file25595ad40336 final : public model_base_crtp<model25596527fdee_file25595ad40336> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model25596527fdee_file25595ad40336() {}
    ##   model25596527fdee_file25595ad40336(stan::io::var_context& context__,
