...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model27de4c50673a_external_namespace::model27de4c50673a_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.5.2/lib/R/etc/Makeconf:211: file27de5314fbde.o] Error 1
...
```
    ...
    ## Warning in file(con, "r"): expanded path length 13629 would be too long for
    ## #ifndef USE_STANC3
    ## #define USE_STANC3
    ## #endif
    ## // Code generated by stanc v2.38.0-41-g0121e19
    ## #include <stan/model/model_header.hpp>
    ## namespace model27de542f8689_file27de4994a81_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file27de4994a81', line 2, column 19 to column 45)"};
    ## class model27de542f8689_file27de4994a81 final : public model_base_crtp<model27de542f8689_file27de4994a81> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model27de542f8689_file27de4994a81() {}
    ##   model27de542f8689_file27de4994a81(stan::io::var_context& context__,
