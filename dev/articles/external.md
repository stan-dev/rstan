...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model27b7341dd947_external_namespace::model27b7341dd947_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.5.2/lib/R/etc/Makeconf:211: file27b77a4d5815.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model27b74e10b424_file27b739505dd8_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file27b739505dd8', line 2, column 19 to column 45)"};
    ## class model27b74e10b424_file27b739505dd8 final : public model_base_crtp<model27b74e10b424_file27b739505dd8> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model27b74e10b424_file27b739505dd8() {}
    ##   model27b74e10b424_file27b739505dd8(stan::io::var_context& context__,
