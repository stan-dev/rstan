...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model26d96521850e_external_namespace::model26d96521850e_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.0/lib/R/etc/Makeconf:199: file26d9788f181.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model26d91b89e440_file26d9af0236d_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file26d9af0236d', line 2, column 19 to column 45)"};
    ## class model26d91b89e440_file26d9af0236d final : public model_base_crtp<model26d91b89e440_file26d9af0236d> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model26d91b89e440_file26d9af0236d() {}
    ##   model26d91b89e440_file26d9af0236d(stan::io::var_context& context__,
