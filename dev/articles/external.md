...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model276e84a3064_external_namespace::model276e84a3064_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.5.2/lib/R/etc/Makeconf:211: file276e4eaf8c98.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model276e180e3abb_file276e41030836_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file276e41030836', line 2, column 19 to column 45)"};
    ## class model276e180e3abb_file276e41030836 final : public model_base_crtp<model276e180e3abb_file276e41030836> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model276e180e3abb_file276e41030836() {}
    ##   model276e180e3abb_file276e41030836(stan::io::var_context& context__,
