...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model287d5f4e8384_external_namespace::model287d5f4e8384_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.1/lib/R/etc/Makeconf:199: file287d5565cbd0.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model287d448d7f6e_file287db8671b8_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file287db8671b8', line 2, column 19 to column 45)"};
    ## class model287d448d7f6e_file287db8671b8 final : public model_base_crtp<model287d448d7f6e_file287db8671b8> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model287d448d7f6e_file287db8671b8() {}
    ##   model287d448d7f6e_file287db8671b8(stan::io::var_context& context__,
