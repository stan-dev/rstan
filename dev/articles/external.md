...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model25717807ba0c_external_namespace::model25717807ba0c_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.0/lib/R/etc/Makeconf:199: file25713406d189.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model2571a617e9c_file25711d71be3a_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file25711d71be3a', line 2, column 19 to column 45)"};
    ## class model2571a617e9c_file25711d71be3a final : public model_base_crtp<model2571a617e9c_file25711d71be3a> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model2571a617e9c_file25711d71be3a() {}
    ##   model2571a617e9c_file25711d71be3a(stan::io::var_context& context__,
