...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model25d02add778e_external_namespace::model25d02add778e_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.5.2/lib/R/etc/Makeconf:211: file25d011c05a0a.o] Error 1
...
```
    ...
    ## #define USE_STANC3
    ## #endif
    ## // Code generated by stanc v2.38.0-41-g0121e19
    ## #include <stan/model/model_header.hpp>
    ## namespace model25d03fae171_file25d07acf8411_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file25d07acf8411', line 2, column 19 to column 45)"};
    ## class model25d03fae171_file25d07acf8411 final : public model_base_crtp<model25d03fae171_file25d07acf8411> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model25d03fae171_file25d07acf8411() {}
    ##   model25d03fae171_file25d07acf8411(stan::io::var_context& context__,
