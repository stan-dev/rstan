...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model264064d51be4_external_namespace::model264064d51be4_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.0/lib/R/etc/Makeconf:199: file2640ba6366d.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model264020530250_file2640414b78f7_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file2640414b78f7', line 2, column 19 to column 45)"};
    ## class model264020530250_file2640414b78f7 final : public model_base_crtp<model264020530250_file2640414b78f7> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model264020530250_file2640414b78f7() {}
    ##   model264020530250_file2640414b78f7(stan::io::var_context& context__,
