...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model251552f0fb73_external_namespace::model251552f0fb73_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.5.2/lib/R/etc/Makeconf:211: file2515405d0372.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model25157f3f5266_file25154267ec31_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file25154267ec31', line 2, column 19 to column 45)"};
    ## class model25157f3f5266_file25154267ec31 final : public model_base_crtp<model25157f3f5266_file25154267ec31> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model25157f3f5266_file25154267ec31() {}
    ##   model25157f3f5266_file25154267ec31(stan::io::var_context& context__,
