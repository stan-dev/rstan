...
```
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.5.2/lib/R/etc/Makeconf:211: file29a43be7c32d.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model29a46fc4d14a_file29a42532fae8_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file29a42532fae8', line 2, column 19 to column 45)"};
    ## class model29a46fc4d14a_file29a42532fae8 final : public model_base_crtp<model29a46fc4d14a_file29a42532fae8> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model29a46fc4d14a_file29a42532fae8() {}
    ##   model29a46fc4d14a_file29a42532fae8(stan::io::var_context& context__,
