...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model28d425c1fdae_external_namespace::model28d425c1fdae_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.1/lib/R/etc/Makeconf:199: file28d44cb6b3dc.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model28d45ca14ac6_file28d42519412b_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file28d42519412b', line 2, column 19 to column 45)"};
    ## class model28d45ca14ac6_file28d42519412b final : public model_base_crtp<model28d45ca14ac6_file28d42519412b> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model28d45ca14ac6_file28d42519412b() {}
    ##   model28d45ca14ac6_file28d42519412b(stan::io::var_context& context__,
