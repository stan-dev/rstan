...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model289b421e9ea6_external_namespace::model289b421e9ea6_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.0/lib/R/etc/Makeconf:199: file289b4386346.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model289b6af82667_file289b7bbbcbf_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file289b7bbbcbf', line 2, column 19 to column 45)"};
    ## class model289b6af82667_file289b7bbbcbf final : public model_base_crtp<model289b6af82667_file289b7bbbcbf> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model289b6af82667_file289b7bbbcbf() {}
    ##   model289b6af82667_file289b7bbbcbf(stan::io::var_context& context__,
