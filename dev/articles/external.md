...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model25c9208fbd14_external_namespace::model25c9208fbd14_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.1/lib/R/etc/Makeconf:199: file25c912c01392.o] Error 1
...
```
    ...
    ## Warning in file(con, "r"): expanded path length 13605 would be too long for
    ## #ifndef USE_STANC3
    ## #define USE_STANC3
    ## #endif
    ## // Code generated by stanc v2.39.0
    ## #include <stan/model/model_header.hpp>
    ## namespace model25c93834bac7_file25c9c58e814_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file25c9c58e814', line 2, column 19 to column 45)"};
    ## class model25c93834bac7_file25c9c58e814 final : public model_base_crtp<model25c93834bac7_file25c9c58e814> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model25c93834bac7_file25c9c58e814() {}
    ##   model25c93834bac7_file25c9c58e814(stan::io::var_context& context__,
    ##                                     unsigned int random_seed__ = 0,
    ##                                     std::ostream* pstream__ = nullptr)
    ##       : model_base_crtp(0) {
    ##     int current_statement__ = 0;
    ##     // suppress unused var warning
    ##     (void) current_s [... truncated]
    ## Warning in file(con, "r"): expanded path length 13605 would be too long for
    ## #ifndef USE_STANC3
    ## #define USE_STANC3
    ## #endif
