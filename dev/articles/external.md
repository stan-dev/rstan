...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model27a766c7886b_external_namespace::model27a766c7886b_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.5.2/lib/R/etc/Makeconf:211: file27a7736927e4.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model27a73494d20e_file27a73702b80_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file27a73702b80', line 2, column 19 to column 45)"};
    ## class model27a73494d20e_file27a73702b80 final : public model_base_crtp<model27a73494d20e_file27a73702b80> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model27a73494d20e_file27a73702b80() {}
    ##   model27a73494d20e_file27a73702b80(stan::io::var_context& context__,
