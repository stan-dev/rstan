...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model265b25031aa8_external_namespace::model265b25031aa8_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.1/lib/R/etc/Makeconf:199: file265b47df547e.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model265b53f67b6d_file265b7cbd46e8_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file265b7cbd46e8', line 2, column 19 to column 45)"};
    ## class model265b53f67b6d_file265b7cbd46e8 final : public model_base_crtp<model265b53f67b6d_file265b7cbd46e8> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model265b53f67b6d_file265b7cbd46e8() {}
    ##   model265b53f67b6d_file265b7cbd46e8(stan::io::var_context& context__,
