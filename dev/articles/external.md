...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model26eb244b7148_external_namespace::model26eb244b7148_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.1/lib/R/etc/Makeconf:199: file26eb6428b402.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model26eb1c331239_file26eb2e784d85_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file26eb2e784d85', line 2, column 19 to column 45)"};
    ## class model26eb1c331239_file26eb2e784d85 final : public model_base_crtp<model26eb1c331239_file26eb2e784d85> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model26eb1c331239_file26eb2e784d85() {}
    ##   model26eb1c331239_file26eb2e784d85(stan::io::var_context& context__,
