...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model26886dea32d_external_namespace::model26886dea32d_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.1/lib/R/etc/Makeconf:199: file2688639de33d.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model2688609f9566_file26886ab191a_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file26886ab191a', line 2, column 19 to column 45)"};
    ## class model2688609f9566_file26886ab191a final : public model_base_crtp<model2688609f9566_file26886ab191a> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model2688609f9566_file26886ab191a() {}
    ##   model2688609f9566_file26886ab191a(stan::io::var_context& context__,
