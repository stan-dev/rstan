...
```
    ...
    ## Error in compileCode(f, code, language = language, verbose = verbose):  int Option = 0; Scalar = double]’
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model24d671aabab7_external_namespace::model24d671aabab7_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.5.2/lib/R/etc/Makeconf:211: file24d64cb7e3ed.o] Error 1
...
```
    ...
    ## Warning in file(con, "r"): expanded path length 13632 would be too long for
    ## #ifndef USE_STANC3
    ## #define USE_STANC3
    ## #endif
    ## // Code generated by stanc v2.37.0-160-g5682fff
    ## #include <stan/model/model_header.hpp>
    ## namespace model24d6da8b8d3_file24d6697b244a_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file24d6697b244a', line 2, column 19 to column 45)"};
    ## class model24d6da8b8d3_file24d6697b244a final : public model_base_crtp<model24d6da8b8d3_file24d6697b244a> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model24d6da8b8d3_file24d6697b244a() {}
    ##   model24d6da8b8d3_file24d6697b244a(stan::io::var_context& context__,
