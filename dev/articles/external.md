...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model260743025c15_external_namespace::model260743025c15_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.1/lib/R/etc/Makeconf:199: file26077538293d.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model26075aa87db9_file2607491a5220_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file2607491a5220', line 2, column 19 to column 45)"};
    ## class model26075aa87db9_file2607491a5220 final : public model_base_crtp<model26075aa87db9_file2607491a5220> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model26075aa87db9_file2607491a5220() {}
    ##   model26075aa87db9_file2607491a5220(stan::io::var_context& context__,
