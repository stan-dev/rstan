...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model279f9927e68_external_namespace::model279f9927e68_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.5.2/lib/R/etc/Makeconf:211: file279f1fdfee9b.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model279fcd633d4_file279f439962a5_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file279f439962a5', line 2, column 19 to column 45)"};
    ## class model279fcd633d4_file279f439962a5 final : public model_base_crtp<model279fcd633d4_file279f439962a5> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model279fcd633d4_file279f439962a5() {}
    ##   model279fcd633d4_file279f439962a5(stan::io::var_context& context__,
