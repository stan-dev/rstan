...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model261acfcfe9e_external_namespace::model261acfcfe9e_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.0/lib/R/etc/Makeconf:199: file261a488406e0.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model261a2e76cd21_file261a22b7e17a_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file261a22b7e17a', line 2, column 19 to column 45)"};
    ## class model261a2e76cd21_file261a22b7e17a final : public model_base_crtp<model261a2e76cd21_file261a22b7e17a> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model261a2e76cd21_file261a22b7e17a() {}
    ##   model261a2e76cd21_file261a22b7e17a(stan::io::var_context& context__,
