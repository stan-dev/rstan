...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model25ab22c232eb_external_namespace::model25ab22c232eb_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.5.2/lib/R/etc/Makeconf:211: file25ab6450459c.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model25ab75dd5687_file25abf74ef31_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file25abf74ef31', line 2, column 19 to column 45)"};
    ## class model25ab75dd5687_file25abf74ef31 final : public model_base_crtp<model25ab75dd5687_file25abf74ef31> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model25ab75dd5687_file25abf74ef31() {}
    ##   model25ab75dd5687_file25abf74ef31(stan::io::var_context& context__,
