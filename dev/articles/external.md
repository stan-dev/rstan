...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model279bf955284_external_namespace::model279bf955284_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.5.2/lib/R/etc/Makeconf:211: file279b5cff9b85.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model279b57c7250b_file279b50637796_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file279b50637796', line 2, column 19 to column 45)"};
    ## class model279b57c7250b_file279b50637796 final : public model_base_crtp<model279b57c7250b_file279b50637796> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model279b57c7250b_file279b50637796() {}
    ##   model279b57c7250b_file279b50637796(stan::io::var_context& context__,
