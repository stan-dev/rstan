...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model2a7621ca67f2_external_namespace::model2a7621ca67f2_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.5.3/lib/R/etc/Makeconf:211: file2a7619e9253.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model2a7628ff8f41_file2a76afad66f_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file2a76afad66f', line 2, column 19 to column 45)"};
    ## class model2a7628ff8f41_file2a76afad66f final : public model_base_crtp<model2a7628ff8f41_file2a76afad66f> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model2a7628ff8f41_file2a76afad66f() {}
    ##   model2a7628ff8f41_file2a76afad66f(stan::io::var_context& context__,
