...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model25626e10af6b_external_namespace::model25626e10af6b_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.1/lib/R/etc/Makeconf:199: file25627f4cc329.o] Error 1
...
```
    ...
    ## Warning in file(con, "r"): expanded path length 13555 would be too long for
    ## #ifndef USE_STANC3
    ## #define USE_STANC3
    ## #endif
    ## // Code generated by stanc 4d256d1
    ## #include <stan/model/model_header.hpp>
    ## namespace model256296a0acc_file2562f7b33_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file2562f7b33', line 2, column 19 to column 45)"};
    ## class model256296a0acc_file2562f7b33 final : public model_base_crtp<model256296a0acc_file2562f7b33> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model256296a0acc_file2562f7b33() {}
    ##   model256296a0acc_file2562f7b33(stan::io::var_context& context__,
