...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model285876cca6f4_external_namespace::model285876cca6f4_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.1/lib/R/etc/Makeconf:199: file2858590634f5.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model2858366110a_file2858645c2a99_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file2858645c2a99', line 2, column 19 to column 45)"};
    ## class model2858366110a_file2858645c2a99 final : public model_base_crtp<model2858366110a_file2858645c2a99> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model2858366110a_file2858645c2a99() {}
    ##   model2858366110a_file2858645c2a99(stan::io::var_context& context__,
