...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model25b973544060_external_namespace::model25b973544060_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.5.2/lib/R/etc/Makeconf:211: file25b935b53bb5.o] Error 1
...
```
    ...
    ## Warning in file(con, "r"): expanded path length 13630 would be too long for
    ## #ifndef USE_STANC3
    ## #define USE_STANC3
    ## #endif
    ## // Code generated by stanc v2.38.0-62-g6014db9
    ## #include <stan/model/model_header.hpp>
    ## namespace model25b9dd14fd4_file25b9240fb1c2_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file25b9240fb1c2', line 2, column 19 to column 45)"};
    ## class model25b9dd14fd4_file25b9240fb1c2 final : public model_base_crtp<model25b9dd14fd4_file25b9240fb1c2> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model25b9dd14fd4_file25b9240fb1c2() {}
    ##   model25b9dd14fd4_file25b9240fb1c2(stan::io::var_context& context__,
