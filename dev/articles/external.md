...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model279c36f42dc3_external_namespace::model279c36f42dc3_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.5.3/lib/R/etc/Makeconf:211: file279c73d36e2d.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model279c27f5c366_file279c74302715_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file279c74302715', line 2, column 19 to column 45)"};
    ## class model279c27f5c366_file279c74302715 final : public model_base_crtp<model279c27f5c366_file279c74302715> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model279c27f5c366_file279c74302715() {}
    ##   model279c27f5c366_file279c74302715(stan::io::var_context& context__,
