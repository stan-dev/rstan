...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model25fb52648d00_external_namespace::model25fb52648d00_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.1/lib/R/etc/Makeconf:199: file25fb5c1676f6.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model25fb302fc590_file25fb4030a998_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file25fb4030a998', line 2, column 19 to column 45)"};
    ## class model25fb302fc590_file25fb4030a998 final : public model_base_crtp<model25fb302fc590_file25fb4030a998> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model25fb302fc590_file25fb4030a998() {}
    ##   model25fb302fc590_file25fb4030a998(stan::io::var_context& context__,
