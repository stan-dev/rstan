...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model2697721baa7f_external_namespace::model2697721baa7f_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.1/lib/R/etc/Makeconf:199: file269761134451.o] Error 1
...
```
    ...
    ## #define USE_STANC3
    ## #endif
    ## // Code generated by stanc 5b824ee
    ## #include <stan/model/model_header.hpp>
    ## namespace model269797fc450_file26971e0e477b_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file26971e0e477b', line 2, column 19 to column 45)"};
    ## class model269797fc450_file26971e0e477b final : public model_base_crtp<model269797fc450_file26971e0e477b> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model269797fc450_file26971e0e477b() {}
    ##   model269797fc450_file26971e0e477b(stan::io::var_context& context__,
