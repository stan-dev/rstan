...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model257a743bf589_external_namespace::model257a743bf589_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.1/lib/R/etc/Makeconf:199: file257a57cd3479.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model257a67f0245e_file257a26c2911_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file257a26c2911', line 2, column 19 to column 45)"};
    ## class model257a67f0245e_file257a26c2911 final : public model_base_crtp<model257a67f0245e_file257a26c2911> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model257a67f0245e_file257a26c2911() {}
    ##   model257a67f0245e_file257a26c2911(stan::io::var_context& context__,
