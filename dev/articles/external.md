...
```
    ...
    ## /home/runner/work/_temp/Library/StanHeaders/include/src/stan/mcmc/hmc/hamiltonians/dense_e_metric.hpp:22:0:   required from ‘double stan::mcmc::dense_e_metric<Model, BaseRNG>::T(stan::mcmc::dense_e_point&) [with Model = model24bf3f7c542f_external_namespace::model24bf3f7c542f_external; BaseRNG = boost::random::mixmax_engine<17, 36, 0>]’
    ...
    ##       |                                                                          ^~~~~~~~~
    ## make: *** [/opt/R/4.6.1/lib/R/etc/Makeconf:199: file24bf930a506.o] Error 1
...
```
    ...
    ## #include <stan/model/model_header.hpp>
    ## namespace model24bf61f08da5_file24bf65ad5937_namespace {
    ## using stan::model::model_base_crtp;
    ## using namespace stan::math;
    ## stan::math::profile_map profiles__;
    ## static constexpr std::array<const char*, 2> locations_array__ =
    ##   {" (found before start of program)",
    ##   " (in 'file24bf65ad5937', line 2, column 19 to column 45)"};
    ## class model24bf61f08da5_file24bf65ad5937 final : public model_base_crtp<model24bf61f08da5_file24bf65ad5937> {
    ## private:
    ##   double sinc_pi;
    ## public:
    ##   ~model24bf61f08da5_file24bf65ad5937() {}
    ##   model24bf61f08da5_file24bf65ad5937(stan::io::var_context& context__,
