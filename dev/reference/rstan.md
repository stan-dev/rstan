...
#>   18 : namespace model27223db6ac35_example_namespace {
...
#>   30 : class model27223db6ac35_example final : public model_base_crtp<model27223db6ac35_example> {
#>   31 : private:
#>   32 :   int N;
#>   33 :   std::vector<double> y;
#>   34 : public:
#>   35 :   ~model27223db6ac35_example() {}
#>   36 :   model27223db6ac35_example(stan::io::var_context& context__, unsigned int
...
#>   47 :       "model27223db6ac35_example_namespace::model27223db6ac35_example";
...
#>   76 :     return "model27223db6ac35_example";
#>   77 :   }
...
#>  102 :       "model27223db6ac35_example_namespace::log_prob";
...
#>  140 :       "model27223db6ac35_example_namespace::log_prob";
...
#>  189 :       "model27223db6ac35_example_namespace::write_array";
...
#>  375 : };
#>  376 : }
#>  377 : using stan_model = model27223db6ac35_example_namespace::model27223db6ac35_example;
#>  378 : #ifndef USING_R
#>  379 : // Boilerplate
...
#>  387 :   return model27223db6ac35_example_namespace::profiles__;
#>  388 : }
#>  389 : #endif
#>  390 : #endif
#>  391 : 
#>  392 : RCPP_MODULE(stan_fit4model27223db6ac35_example_mod) {
#>  393 :   class_<rstan::stan_fit<stan_model, boost::random::mixmax> >(
#>  394 :       "stan_fit4model27223db6ac35_example")
#>  395 : 
...
#>  451 : // declarations
#>  452 : extern "C" {
#>  453 : SEXP file27223f9643a8( ) ;
#>  454 : }
#>  455 : 
#>  456 : // definition
#>  457 : SEXP file27223f9643a8() {
...
#> 
#> Samples were drawn using NUTS(diag_e) at Tue Dec 16 17:57:10 2025.
