...
#>   15 : #endif
#>   16 : // Code generated by stanc v2.37.0-160-g5682fff
#>   17 : #include <stan/model/model_header.hpp>
#>   18 : namespace model1c5813078dd6_example_namespace {
...
#>   30 : class model1c5813078dd6_example final : public model_base_crtp<model1c5813078dd6_example> {
#>   31 : private:
#>   32 :   int N;
#>   33 :   std::vector<double> y;
#>   34 : public:
#>   35 :   ~model1c5813078dd6_example() {}
#>   36 :   model1c5813078dd6_example(stan::io::var_context& context__, unsigned int
...
#>   47 :       "model1c5813078dd6_example_namespace::model1c5813078dd6_example";
...
#>   76 :     return "model1c5813078dd6_example";
#>   77 :   }
#>   78 :   inline std::vector<std::string> model_compile_info() const noexcept {
#>   79 :     return std::vector<std::string>{"stanc_version = stanc3 v2.37.0-160-g5682fff",
#>   80 :              "stancflags = --"};
#>   81 :   }
#>   82 :   // Base log prob
...
#>  102 :       "model1c5813078dd6_example_namespace::log_prob";
...
#>  140 :       "model1c5813078dd6_example_namespace::log_prob";
...
#>  189 :       "model1c5813078dd6_example_namespace::write_array";
...
#>  375 : };
#>  376 : }
#>  377 : using stan_model = model1c5813078dd6_example_namespace::model1c5813078dd6_example;
#>  378 : #ifndef USING_R
#>  379 : // Boilerplate
...
#>  387 :   return model1c5813078dd6_example_namespace::profiles__;
#>  388 : }
#>  389 : #endif
#>  390 : #endif
#>  391 : 
#>  392 : RCPP_MODULE(stan_fit4model1c5813078dd6_example_mod) {
#>  393 :   class_<rstan::stan_fit<stan_model, boost::random::mixmax> >(
#>  394 :       "stan_fit4model1c5813078dd6_example")
#>  395 : 
...
#>  451 : // declarations
#>  452 : extern "C" {
#>  453 : SEXP file1c58523617e1( ) ;
#>  454 : }
#>  455 : 
#>  456 : // definition
#>  457 : SEXP file1c58523617e1() {
...
#> 
#> Samples were drawn using NUTS(diag_e) at Thu Dec  4 21:19:10 2025.
