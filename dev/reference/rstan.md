...
#>   15 : #endif
#>   16 : // Code generated by stanc v2.38.0
#>   17 : #include <stan/model/model_header.hpp>
#>   18 : namespace model1e3d7ab0a7eb_example_namespace {
...
#>   30 : class model1e3d7ab0a7eb_example final : public model_base_crtp<model1e3d7ab0a7eb_example> {
#>   31 : private:
#>   32 :   int N;
#>   33 :   std::vector<double> y;
#>   34 : public:
#>   35 :   ~model1e3d7ab0a7eb_example() {}
#>   36 :   model1e3d7ab0a7eb_example(stan::io::var_context& context__, unsigned int
...
#>   47 :       "model1e3d7ab0a7eb_example_namespace::model1e3d7ab0a7eb_example";
...
#>   76 :     return "model1e3d7ab0a7eb_example";
#>   77 :   }
#>   78 :   inline std::vector<std::string> model_compile_info() const noexcept {
#>   79 :     return std::vector<std::string>{"stanc_version = stanc3 v2.38.0",
#>   80 :              "stancflags = --"};
#>   81 :   }
#>   82 :   // Base log prob
...
#>  102 :       "model1e3d7ab0a7eb_example_namespace::log_prob";
...
#>  142 :       "model1e3d7ab0a7eb_example_namespace::log_prob";
...
#>  193 :       "model1e3d7ab0a7eb_example_namespace::write_array";
...
#>  379 : };
#>  380 : }
#>  381 : using stan_model = model1e3d7ab0a7eb_example_namespace::model1e3d7ab0a7eb_example;
#>  382 : #ifndef USING_R
#>  383 : // Boilerplate
...
#>  391 :   return model1e3d7ab0a7eb_example_namespace::profiles__;
#>  392 : }
#>  393 : #endif
#>  394 : #endif
#>  395 : 
#>  396 : RCPP_MODULE(stan_fit4model1e3d7ab0a7eb_example_mod) {
#>  397 :   class_<rstan::stan_fit<stan_model, boost::random::mixmax> >(
#>  398 :       "stan_fit4model1e3d7ab0a7eb_example")
#>  399 : 
...
#>  455 : // declarations
#>  456 : extern "C" {
#>  457 : SEXP file1e3d16223e48( ) ;
#>  458 : }
#>  459 : 
#>  460 : // definition
#>  461 : SEXP file1e3d16223e48() {
...
#> 
#> Samples were drawn using NUTS(diag_e) at Wed Jan 14 15:34:22 2026.
