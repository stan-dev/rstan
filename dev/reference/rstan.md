...
#>   18 : namespace model2486766152df_example_namespace {
...
#>   30 : class model2486766152df_example final : public model_base_crtp<model2486766152df_example> {
#>   31 : private:
#>   32 :   int N;
#>   33 :   std::vector<double> y;
#>   34 : public:
#>   35 :   ~model2486766152df_example() {}
#>   36 :   model2486766152df_example(stan::io::var_context& context__, unsigned int
...
#>   47 :       "model2486766152df_example_namespace::model2486766152df_example";
...
#>   76 :     return "model2486766152df_example";
#>   77 :   }
...
#>  102 :       "model2486766152df_example_namespace::log_prob";
...
#>  140 :       "model2486766152df_example_namespace::log_prob";
...
#>  189 :       "model2486766152df_example_namespace::write_array";
...
#>  375 : };
#>  376 : }
#>  377 : using stan_model = model2486766152df_example_namespace::model2486766152df_example;
#>  378 : #ifndef USING_R
#>  379 : // Boilerplate
...
#>  387 :   return model2486766152df_example_namespace::profiles__;
#>  388 : }
#>  389 : #endif
#>  390 : #endif
#>  391 : 
#>  392 : RCPP_MODULE(stan_fit4model2486766152df_example_mod) {
#>  393 :   class_<rstan::stan_fit<stan_model, boost::random::mixmax> >(
#>  394 :       "stan_fit4model2486766152df_example")
#>  395 : 
...
#>  451 : // declarations
#>  452 : extern "C" {
#>  453 : SEXP file24869388e14( ) ;
#>  454 : }
#>  455 : 
#>  456 : // definition
#>  457 : SEXP file24869388e14() {
...
#> 
#> Samples were drawn using NUTS(diag_e) at Fri Dec 12 09:43:37 2025.
