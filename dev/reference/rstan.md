...
#>   15 : #endif
#>   16 : // Code generated by stanc v2.38.0-85-g582ade1
#>   17 : #include <stan/model/model_header.hpp>
#>   18 : namespace model217513f061a7_example_namespace {
...
#>   30 : class model217513f061a7_example final : public model_base_crtp<model217513f061a7_example> {
#>   31 : private:
#>   32 :   int N;
#>   33 :   std::vector<double> y;
#>   34 : public:
#>   35 :   ~model217513f061a7_example() {}
#>   36 :   model217513f061a7_example(stan::io::var_context& context__, unsigned int
...
#>   47 :       "model217513f061a7_example_namespace::model217513f061a7_example";
...
#>   76 :     return "model217513f061a7_example";
#>   77 :   }
#>   78 :   inline std::vector<std::string> model_compile_info() const noexcept {
#>   79 :     return std::vector<std::string>{"stanc_version = stanc3 v2.38.0-85-g582ade1",
#>   80 :              "stancflags = --"};
#>   81 :   }
#>   82 :   // Base log prob
...
#>  102 :       "model217513f061a7_example_namespace::log_prob";
...
#>  142 :       "model217513f061a7_example_namespace::log_prob";
...
#>  193 :       "model217513f061a7_example_namespace::write_array";
...
#>  379 : };
#>  380 : }
#>  381 : using stan_model = model217513f061a7_example_namespace::model217513f061a7_example;
#>  382 : #ifndef USING_R
#>  383 : // Boilerplate
...
#>  391 :   return model217513f061a7_example_namespace::profiles__;
#>  392 : }
#>  393 : #endif
#>  394 : #endif
#>  395 : 
#>  396 : RCPP_MODULE(stan_fit4model217513f061a7_example_mod) {
#>  397 :   class_<rstan::stan_fit<stan_model, boost::random::mixmax> >(
#>  398 :       "stan_fit4model217513f061a7_example")
#>  399 : 
...
#>  455 : // declarations
#>  456 : extern "C" {
#>  457 : SEXP file21751f26e788( ) ;
#>  458 : }
#>  459 : 
#>  460 : // definition
#>  461 : SEXP file21751f26e788() {
...
#> 
#> Samples were drawn using NUTS(diag_e) at Wed Mar 25 16:16:43 2026.
