...
#>   18 : namespace model1d915cb1ea74_example_namespace {
...
#>   30 : class model1d915cb1ea74_example final : public model_base_crtp<model1d915cb1ea74_example> {
#>   31 : private:
#>   32 :   int N;
#>   33 :   std::vector<double> y;
#>   34 : public:
#>   35 :   ~model1d915cb1ea74_example() {}
#>   36 :   model1d915cb1ea74_example(stan::io::var_context& context__, unsigned int
...
#>   47 :       "model1d915cb1ea74_example_namespace::model1d915cb1ea74_example";
...
#>   76 :     return "model1d915cb1ea74_example";
#>   77 :   }
...
#>  102 :       "model1d915cb1ea74_example_namespace::log_prob";
...
#>  142 :       "model1d915cb1ea74_example_namespace::log_prob";
...
#>  193 :       "model1d915cb1ea74_example_namespace::write_array";
...
#>  379 : };
#>  380 : }
#>  381 : using stan_model = model1d915cb1ea74_example_namespace::model1d915cb1ea74_example;
#>  382 : #ifndef USING_R
#>  383 : // Boilerplate
...
#>  391 :   return model1d915cb1ea74_example_namespace::profiles__;
#>  392 : }
#>  393 : #endif
#>  394 : #endif
#>  395 : 
#>  396 : RCPP_MODULE(stan_fit4model1d915cb1ea74_example_mod) {
#>  397 :   class_<rstan::stan_fit<stan_model, boost::random::mixmax> >(
#>  398 :       "stan_fit4model1d915cb1ea74_example")
#>  399 : 
...
#>  455 : // declarations
#>  456 : extern "C" {
#>  457 : SEXP file1d912a22ccaa( ) ;
#>  458 : }
#>  459 : 
#>  460 : // definition
#>  461 : SEXP file1d912a22ccaa() {
...
#> 
#> Samples were drawn using NUTS(diag_e) at Tue Jun  2 14:56:41 2026.
