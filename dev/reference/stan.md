...
#> 
#> Samples were drawn using NUTS(diag_e) at Sun Jul 12 13:20:59 2026.
...
#> 
#> Samples were drawn using NUTS(diag_e) at Sun Jul 12 13:21:53 2026.
#> For each parameter, n_eff is a crude measure of effective sample size,
#> and Rhat is the potential scale reduction factor on split chains (at 
#> convergence, Rhat=1).
plot(exfit)
...
#> 
#> Samples were drawn using NUTS(diag_e) at Sun Jul 12 13:22:48 2026.
#> For each parameter, n_eff is a crude measure of effective sample size,
#> and Rhat is the potential scale reduction factor on split chains (at 
#> convergence, Rhat=1).
...
#> 
#> Samples were drawn using NUTS(diag_e) at Sun Jul 12 13:22:49 2026.
#> For each parameter, n_eff is a crude measure of effective sample size,
#> and Rhat is the potential scale reduction factor on split chains (at 
#> convergence, Rhat=1).
# }
