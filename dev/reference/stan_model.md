...
#>   18 : namespace model1e255876f5da__namespace {
...
#>   27 : class model1e255876f5da_ final : public model_base_crtp<model1e255876f5da_> {
#>   28 : private:
#>   29 :   double y_mean;
#>   30 : public:
#>   31 :   ~model1e255876f5da_() {}
#>   32 :   model1e255876f5da_(stan::io::var_context& context__, unsigned int
...
#>   43 :       "model1e255876f5da__namespace::model1e255876f5da_";
...
#>   62 :     return "model1e255876f5da_";
#>   63 :   }
#>   64 :   inline std::vector<std::string> model_compile_info() const noexcept {
#>   65 :     return std::vector<std::string>{"stanc_version = stanc3 v2.37.0-175-gdbd423e",
#>   66 :              "stancflags = --"};
#>   67 :   }
#>   68 :   // Base log prob
...
#>   88 :       "model1e255876f5da__namespace::log_prob";
...
#>  125 :       "model1e255876f5da__namespace::log_prob";
...
#>  173 :       "model1e255876f5da__namespace::write_array";
...
#>  359 : };
#>  360 : }
#>  361 : using stan_model = model1e255876f5da__namespace::model1e255876f5da_;
#>  362 : #ifndef USING_R
#>  363 : // Boilerplate
...
#>  371 :   return model1e255876f5da__namespace::profiles__;
#>  372 : }
#>  373 : #endif
#>  374 : #endif
#>  375 : 
#>  376 : RCPP_MODULE(stan_fit4model1e255876f5da__mod) {
#>  377 :   class_<rstan::stan_fit<stan_model, boost::random::mixmax> >(
#>  378 :       "stan_fit4model1e255876f5da_")
#>  379 : 
...
#>  435 : // declarations
#>  436 : extern "C" {
#>  437 : SEXP file1e256359ae00( ) ;
#>  438 : }
#>  439 : 
#>  440 : // definition
#>  441 : SEXP file1e256359ae00() {
