...
#>   18 : namespace model203a56d326a__namespace {
...
#>   27 : class model203a56d326a_ final : public model_base_crtp<model203a56d326a_> {
#>   28 : private:
#>   29 :   double y_mean;
#>   30 : public:
#>   31 :   ~model203a56d326a_() {}
#>   32 :   model203a56d326a_(stan::io::var_context& context__, unsigned int
...
#>   43 :       "model203a56d326a__namespace::model203a56d326a_";
...
#>   88 :       "model203a56d326a__namespace::log_prob";
...
#>  125 :       "model203a56d326a__namespace::log_prob";
...
#>  173 :       "model203a56d326a__namespace::write_array";
...
#>  359 : };
#>  360 : }
#>  361 : using stan_model = model203a56d326a__namespace::model203a56d326a_;
#>  362 : #ifndef USING_R
#>  363 : // Boilerplate
...
#>  371 :   return model203a56d326a__namespace::profiles__;
#>  372 : }
#>  373 : #endif
#>  374 : #endif
#>  375 : 
#>  376 : RCPP_MODULE(stan_fit4model203a56d326a__mod) {
#>  377 :   class_<rstan::stan_fit<stan_model, boost::random::mixmax> >(
#>  378 :       "stan_fit4model203a56d326a_")
#>  379 : 
...
#>  435 : // declarations
#>  436 : extern "C" {
#>  437 : SEXP file203a7cc8d298( ) ;
#>  438 : }
#>  439 : 
#>  440 : // definition
#>  441 : SEXP file203a7cc8d298() {
