...
#>   18 : namespace model206d67ec873b__namespace {
...
#>   27 : class model206d67ec873b_ final : public model_base_crtp<model206d67ec873b_> {
#>   28 : private:
#>   29 :   double y_mean;
#>   30 : public:
#>   31 :   ~model206d67ec873b_() {}
#>   32 :   model206d67ec873b_(stan::io::var_context& context__, unsigned int
...
#>   43 :       "model206d67ec873b__namespace::model206d67ec873b_";
...
#>   88 :       "model206d67ec873b__namespace::log_prob";
...
#>  125 :       "model206d67ec873b__namespace::log_prob";
...
#>  173 :       "model206d67ec873b__namespace::write_array";
...
#>  359 : };
#>  360 : }
#>  361 : using stan_model = model206d67ec873b__namespace::model206d67ec873b_;
#>  362 : #ifndef USING_R
#>  363 : // Boilerplate
...
#>  371 :   return model206d67ec873b__namespace::profiles__;
#>  372 : }
#>  373 : #endif
#>  374 : #endif
#>  375 : 
#>  376 : RCPP_MODULE(stan_fit4model206d67ec873b__mod) {
#>  377 :   class_<rstan::stan_fit<stan_model, boost::random::mixmax> >(
#>  378 :       "stan_fit4model206d67ec873b_")
#>  379 : 
...
#>  435 : // declarations
#>  436 : extern "C" {
#>  437 : SEXP file206d4d635f5a( ) ;
#>  438 : }
#>  439 : 
#>  440 : // definition
#>  441 : SEXP file206d4d635f5a() {
