...
#>   18 : namespace model1c58560fe91c__namespace {
...
#>   27 : class model1c58560fe91c_ final : public model_base_crtp<model1c58560fe91c_> {
#>   28 : private:
#>   29 :   double y_mean;
#>   30 : public:
#>   31 :   ~model1c58560fe91c_() {}
#>   32 :   model1c58560fe91c_(stan::io::var_context& context__, unsigned int
...
#>   43 :       "model1c58560fe91c__namespace::model1c58560fe91c_";
...
#>   88 :       "model1c58560fe91c__namespace::log_prob";
...
#>  124 :       "model1c58560fe91c__namespace::log_prob";
...
#>  171 :       "model1c58560fe91c__namespace::write_array";
...
#>  357 : };
#>  358 : }
#>  359 : using stan_model = model1c58560fe91c__namespace::model1c58560fe91c_;
#>  360 : #ifndef USING_R
#>  361 : // Boilerplate
...
#>  369 :   return model1c58560fe91c__namespace::profiles__;
#>  370 : }
#>  371 : #endif
#>  372 : #endif
#>  373 : 
#>  374 : RCPP_MODULE(stan_fit4model1c58560fe91c__mod) {
#>  375 :   class_<rstan::stan_fit<stan_model, boost::random::mixmax> >(
#>  376 :       "stan_fit4model1c58560fe91c_")
#>  377 : 
...
#>  433 : // declarations
#>  434 : extern "C" {
#>  435 : SEXP file1c5869efec99( ) ;
#>  436 : }
#>  437 : 
#>  438 : // definition
#>  439 : SEXP file1c5869efec99() {
