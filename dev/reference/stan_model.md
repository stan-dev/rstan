...
#>   18 : namespace model1bf8e82c605__namespace {
...
#>   27 : class model1bf8e82c605_ final : public model_base_crtp<model1bf8e82c605_> {
#>   28 : private:
#>   29 :   double y_mean;
#>   30 : public:
#>   31 :   ~model1bf8e82c605_() {}
#>   32 :   model1bf8e82c605_(stan::io::var_context& context__, unsigned int
...
#>   43 :       "model1bf8e82c605__namespace::model1bf8e82c605_";
...
#>   88 :       "model1bf8e82c605__namespace::log_prob";
...
#>  124 :       "model1bf8e82c605__namespace::log_prob";
...
#>  171 :       "model1bf8e82c605__namespace::write_array";
...
#>  357 : };
#>  358 : }
#>  359 : using stan_model = model1bf8e82c605__namespace::model1bf8e82c605_;
#>  360 : #ifndef USING_R
#>  361 : // Boilerplate
...
#>  369 :   return model1bf8e82c605__namespace::profiles__;
#>  370 : }
#>  371 : #endif
#>  372 : #endif
#>  373 : 
#>  374 : RCPP_MODULE(stan_fit4model1bf8e82c605__mod) {
#>  375 :   class_<rstan::stan_fit<stan_model, boost::random::mixmax> >(
#>  376 :       "stan_fit4model1bf8e82c605_")
#>  377 : 
...
#>  433 : // declarations
#>  434 : extern "C" {
#>  435 : SEXP file1bf87d101fad( ) ;
#>  436 : }
#>  437 : 
#>  438 : // definition
#>  439 : SEXP file1bf87d101fad() {
