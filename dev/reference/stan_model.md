...
#>   18 : namespace model1e3d9365bad__namespace {
...
#>   27 : class model1e3d9365bad_ final : public model_base_crtp<model1e3d9365bad_> {
#>   28 : private:
#>   29 :   double y_mean;
#>   30 : public:
#>   31 :   ~model1e3d9365bad_() {}
#>   32 :   model1e3d9365bad_(stan::io::var_context& context__, unsigned int
...
#>   43 :       "model1e3d9365bad__namespace::model1e3d9365bad_";
...
#>   88 :       "model1e3d9365bad__namespace::log_prob";
...
#>  125 :       "model1e3d9365bad__namespace::log_prob";
...
#>  173 :       "model1e3d9365bad__namespace::write_array";
...
#>  359 : };
#>  360 : }
#>  361 : using stan_model = model1e3d9365bad__namespace::model1e3d9365bad_;
#>  362 : #ifndef USING_R
#>  363 : // Boilerplate
...
#>  371 :   return model1e3d9365bad__namespace::profiles__;
#>  372 : }
#>  373 : #endif
#>  374 : #endif
#>  375 : 
#>  376 : RCPP_MODULE(stan_fit4model1e3d9365bad__mod) {
#>  377 :   class_<rstan::stan_fit<stan_model, boost::random::mixmax> >(
#>  378 :       "stan_fit4model1e3d9365bad_")
#>  379 : 
...
#>  435 : // declarations
#>  436 : extern "C" {
#>  437 : SEXP file1e3d3fbe2612( ) ;
#>  438 : }
#>  439 : 
#>  440 : // definition
#>  441 : SEXP file1e3d3fbe2612() {
