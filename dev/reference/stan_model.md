...
#>   18 : namespace model24864e5940df__namespace {
...
#>   27 : class model24864e5940df_ final : public model_base_crtp<model24864e5940df_> {
#>   28 : private:
#>   29 :   double y_mean;
#>   30 : public:
#>   31 :   ~model24864e5940df_() {}
#>   32 :   model24864e5940df_(stan::io::var_context& context__, unsigned int
...
#>   43 :       "model24864e5940df__namespace::model24864e5940df_";
...
#>   88 :       "model24864e5940df__namespace::log_prob";
...
#>  124 :       "model24864e5940df__namespace::log_prob";
...
#>  171 :       "model24864e5940df__namespace::write_array";
...
#>  357 : };
#>  358 : }
#>  359 : using stan_model = model24864e5940df__namespace::model24864e5940df_;
#>  360 : #ifndef USING_R
#>  361 : // Boilerplate
...
#>  369 :   return model24864e5940df__namespace::profiles__;
#>  370 : }
#>  371 : #endif
#>  372 : #endif
#>  373 : 
#>  374 : RCPP_MODULE(stan_fit4model24864e5940df__mod) {
#>  375 :   class_<rstan::stan_fit<stan_model, boost::random::mixmax> >(
#>  376 :       "stan_fit4model24864e5940df_")
#>  377 : 
...
#>  433 : // declarations
#>  434 : extern "C" {
#>  435 : SEXP file2486cb96439( ) ;
#>  436 : }
#>  437 : 
#>  438 : // definition
#>  439 : SEXP file2486cb96439() {
