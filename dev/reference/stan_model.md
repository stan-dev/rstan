...
#>   18 : namespace model1c5a4bfd16e0__namespace {
...
#>   27 : class model1c5a4bfd16e0_ final : public model_base_crtp<model1c5a4bfd16e0_> {
#>   28 : private:
#>   29 :   double y_mean;
#>   30 : public:
#>   31 :   ~model1c5a4bfd16e0_() {}
#>   32 :   model1c5a4bfd16e0_(stan::io::var_context& context__, unsigned int
...
#>   43 :       "model1c5a4bfd16e0__namespace::model1c5a4bfd16e0_";
...
#>   88 :       "model1c5a4bfd16e0__namespace::log_prob";
...
#>  125 :       "model1c5a4bfd16e0__namespace::log_prob";
...
#>  173 :       "model1c5a4bfd16e0__namespace::write_array";
...
#>  359 : };
#>  360 : }
#>  361 : using stan_model = model1c5a4bfd16e0__namespace::model1c5a4bfd16e0_;
#>  362 : #ifndef USING_R
#>  363 : // Boilerplate
...
#>  371 :   return model1c5a4bfd16e0__namespace::profiles__;
#>  372 : }
#>  373 : #endif
#>  374 : #endif
#>  375 : 
#>  376 : RCPP_MODULE(stan_fit4model1c5a4bfd16e0__mod) {
#>  377 :   class_<rstan::stan_fit<stan_model, boost::random::mixmax> >(
#>  378 :       "stan_fit4model1c5a4bfd16e0_")
#>  379 : 
...
#>  435 : // declarations
#>  436 : extern "C" {
#>  437 : SEXP file1c5a17517337( ) ;
#>  438 : }
#>  439 : 
#>  440 : // definition
#>  441 : SEXP file1c5a17517337() {
