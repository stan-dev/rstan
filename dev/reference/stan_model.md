...
#>   18 : namespace model1bdf571fde2a__namespace {
...
#>   27 : class model1bdf571fde2a_ final : public model_base_crtp<model1bdf571fde2a_> {
#>   28 : private:
#>   29 :   double y_mean;
#>   30 : public:
#>   31 :   ~model1bdf571fde2a_() {}
#>   32 :   model1bdf571fde2a_(stan::io::var_context& context__, unsigned int
...
#>   43 :       "model1bdf571fde2a__namespace::model1bdf571fde2a_";
...
#>   62 :     return "model1bdf571fde2a_";
#>   63 :   }
#>   64 :   inline std::vector<std::string> model_compile_info() const noexcept {
#>   65 :     return std::vector<std::string>{"stanc_version = stanc3 v2.37.0-160-g5682fff",
#>   66 :              "stancflags = --"};
#>   67 :   }
#>   68 :   // Base log prob
...
#>   88 :       "model1bdf571fde2a__namespace::log_prob";
...
#>  124 :       "model1bdf571fde2a__namespace::log_prob";
...
#>  171 :       "model1bdf571fde2a__namespace::write_array";
...
#>  357 : };
#>  358 : }
#>  359 : using stan_model = model1bdf571fde2a__namespace::model1bdf571fde2a_;
#>  360 : #ifndef USING_R
#>  361 : // Boilerplate
...
#>  369 :   return model1bdf571fde2a__namespace::profiles__;
#>  370 : }
#>  371 : #endif
#>  372 : #endif
#>  373 : 
#>  374 : RCPP_MODULE(stan_fit4model1bdf571fde2a__mod) {
#>  375 :   class_<rstan::stan_fit<stan_model, boost::random::mixmax> >(
#>  376 :       "stan_fit4model1bdf571fde2a_")
#>  377 : 
...
#>  433 : // declarations
#>  434 : extern "C" {
#>  435 : SEXP file1bdf22ff6e92( ) ;
#>  436 : }
#>  437 : 
#>  438 : // definition
#>  439 : SEXP file1bdf22ff6e92() {
