...
#>   18 : namespace model1ba611961f28__namespace {
...
#>   27 : class model1ba611961f28_ final : public model_base_crtp<model1ba611961f28_> {
#>   28 : private:
#>   29 :   double y_mean;
#>   30 : public:
#>   31 :   ~model1ba611961f28_() {}
#>   32 :   model1ba611961f28_(stan::io::var_context& context__, unsigned int
...
#>   43 :       "model1ba611961f28__namespace::model1ba611961f28_";
...
#>   88 :       "model1ba611961f28__namespace::log_prob";
...
#>  125 :       "model1ba611961f28__namespace::log_prob";
...
#>  173 :       "model1ba611961f28__namespace::write_array";
...
#>  359 : };
#>  360 : }
#>  361 : using stan_model = model1ba611961f28__namespace::model1ba611961f28_;
#>  362 : #ifndef USING_R
#>  363 : // Boilerplate
...
#>  371 :   return model1ba611961f28__namespace::profiles__;
#>  372 : }
#>  373 : #endif
#>  374 : #endif
#>  375 : 
#>  376 : RCPP_MODULE(stan_fit4model1ba611961f28__mod) {
#>  377 :   class_<rstan::stan_fit<stan_model, boost::random::mixmax> >(
#>  378 :       "stan_fit4model1ba611961f28_")
#>  379 : 
...
#>  435 : // declarations
#>  436 : extern "C" {
#>  437 : SEXP file1ba61b6fa89c( ) ;
#>  438 : }
#>  439 : 
#>  440 : // definition
#>  441 : SEXP file1ba61b6fa89c() {
