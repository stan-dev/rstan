...
#>   18 : namespace model1e4f742da82__namespace {
...
#>   27 : class model1e4f742da82_ final : public model_base_crtp<model1e4f742da82_> {
#>   28 : private:
#>   29 :   double y_mean;
#>   30 : public:
#>   31 :   ~model1e4f742da82_() {}
#>   32 :   model1e4f742da82_(stan::io::var_context& context__, unsigned int
...
#>   43 :       "model1e4f742da82__namespace::model1e4f742da82_";
...
#>   88 :       "model1e4f742da82__namespace::log_prob";
...
#>  124 :       "model1e4f742da82__namespace::log_prob";
...
#>  171 :       "model1e4f742da82__namespace::write_array";
...
#>  357 : };
#>  358 : }
#>  359 : using stan_model = model1e4f742da82__namespace::model1e4f742da82_;
#>  360 : #ifndef USING_R
#>  361 : // Boilerplate
...
#>  369 :   return model1e4f742da82__namespace::profiles__;
#>  370 : }
#>  371 : #endif
#>  372 : #endif
#>  373 : 
#>  374 : RCPP_MODULE(stan_fit4model1e4f742da82__mod) {
#>  375 :   class_<rstan::stan_fit<stan_model, boost::random::mixmax> >(
#>  376 :       "stan_fit4model1e4f742da82_")
#>  377 : 
...
#>  433 : // declarations
#>  434 : extern "C" {
#>  435 : SEXP file1e4f4a89dff2( ) ;
#>  436 : }
#>  437 : 
#>  438 : // definition
#>  439 : SEXP file1e4f4a89dff2() {
