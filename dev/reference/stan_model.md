...
#>   18 : namespace model20452275f620__namespace {
...
#>   27 : class model20452275f620_ final : public model_base_crtp<model20452275f620_> {
#>   28 : private:
#>   29 :   double y_mean;
#>   30 : public:
#>   31 :   ~model20452275f620_() {}
#>   32 :   model20452275f620_(stan::io::var_context& context__, unsigned int
...
#>   43 :       "model20452275f620__namespace::model20452275f620_";
...
#>   88 :       "model20452275f620__namespace::log_prob";
...
#>  125 :       "model20452275f620__namespace::log_prob";
...
#>  173 :       "model20452275f620__namespace::write_array";
...
#>  359 : };
#>  360 : }
#>  361 : using stan_model = model20452275f620__namespace::model20452275f620_;
#>  362 : #ifndef USING_R
#>  363 : // Boilerplate
...
#>  371 :   return model20452275f620__namespace::profiles__;
#>  372 : }
#>  373 : #endif
#>  374 : #endif
#>  375 : 
#>  376 : RCPP_MODULE(stan_fit4model20452275f620__mod) {
#>  377 :   class_<rstan::stan_fit<stan_model, boost::random::mixmax> >(
#>  378 :       "stan_fit4model20452275f620_")
#>  379 : 
...
#>  435 : // declarations
#>  436 : extern "C" {
#>  437 : SEXP file2045612c4581( ) ;
#>  438 : }
#>  439 : 
#>  440 : // definition
#>  441 : SEXP file2045612c4581() {
