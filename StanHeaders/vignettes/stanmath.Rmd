...
```{r}
Sys.setenv(PKG_CXXFLAGS = "-D_REENTRANT")
tbb_pkg_libs <- system.file(ifelse(.Platform$OS.type == "windows", "libs", "lib"), 
                                   .Platform$r_arch, package = "RcppParallel")
...
```{r}
Sys.setenv(PKG_CXXFLAGS = "-DSTAN_THREADS -D_REENTRANT")
...
exposeClass("sparselm_stan",
      ...
      file = tf,
      Rfile = FALSE)
# don't specify -DSTAN_THREADS if not using them
Sys.setenv(PKG_CPPFLAGS = paste0("-D_REENTRANT -I",
