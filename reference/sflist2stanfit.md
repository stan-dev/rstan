...
[`stan`](https://mc-stan.org/rstan/reference/stan.md) by parallel and it
returns a list of `stanfit` objects, this function can be used to create
one `stanfit` object from the list.
