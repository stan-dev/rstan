...
- stanmodel:
  ...
  [`stanc`](https://mc-stan.org/rstan/reference/stanc.md) or the path to
  a Stan program (`.stan` file). In any of these cases, the underlying
  Stan program should contain a non-empty `functions` block.
