...
- plotfun:
  ...
  [`stan_plot`](https://mc-stan.org/rstan/reference/stan_plot.md), which
  generates a plot of credible intervals and point estimates. See
  [`rstan-plotting-functions`](https://mc-stan.org/rstan/reference/plotting-functions.md)
...
[`Plot options`](https://mc-stan.org/rstan/reference/stan_plot_options.md)
