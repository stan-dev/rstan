...
[`stan`](https://mc-stan.org/rstan/reference/stan.md) or the lower-level
methods
[`sampling`](https://mc-stan.org/rstan/reference/stanmodel-method-sampling.md)
and [`vb`](https://mc-stan.org/rstan/reference/stanmodel-method-vb.md)
(which are defined on class
[`stanmodel`](https://mc-stan.org/rstan/reference/stanmodel-class.md)).
...
- `print`:
  ...
  [`print.stanfit`](https://mc-stan.org/rstan/reference/print.stanfit.md).

- `plot`:

  Create various plots summarizing the fitted model. See
  [`plot,stanfit-method`](https://mc-stan.org/rstan/reference/stanfit-method-plot.md).

- `summary`:

  Summarize the distributions of estimated parameters and derived
  quantities using the posterior draws. See
  [`summary,stanfit-method`](https://mc-stan.org/rstan/reference/stanfit-method-summary.md).
...
- `as.array`, `as.matrix`, `as.data.frame`:
  ...
  See
  [`as.array.stanfit`](https://mc-stan.org/rstan/reference/stanfit2array-method.md).
...
- `As.mcmc.list`:
  ...
  package coda. See
  [`As.mcmc.list`](https://mc-stan.org/rstan/reference/As.mcmc.list.md).
...
- `log_prob`:
  ...
  documentation in
  [`log_prob`](https://mc-stan.org/rstan/reference/stanfit-method-logprob.md).
...
- `grad_log_prob`:
  ...
  [`grad_log_prob`](https://mc-stan.org/rstan/reference/stanfit-method-logprob.md).
...
- `unconstrain_pars`:
  ...
  [`unconstrain_pars`](https://mc-stan.org/rstan/reference/stanfit-method-logprob.md).
...
- `constrain_pars`:
  ...
  [`constrain_pars`](https://mc-stan.org/rstan/reference/stanfit-method-logprob.md).
...
[`stan`](https://mc-stan.org/rstan/reference/stan.md) and
[`stanmodel`](https://mc-stan.org/rstan/reference/stanmodel-class.md)
...
#> 
#> Samples were drawn using NUTS(diag_e) at Wed Dec 10 00:27:12 2025.
...
#> 
#> Samples were drawn using NUTS(diag_e) at Wed Dec 10 00:15:43 2025.
#> For each parameter, n_eff is a crude measure of effective sample size,
#> and Rhat is the potential scale reduction factor on split chains (at 
#> convergence, Rhat=1).
# \dontrun{
