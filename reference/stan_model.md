...
- stanc_ret:
  ...
  [`stanc`](https://mc-stan.org/rstan/reference/stanc.md) function. The
  list can be used to specify the model instead of using the `file` or
  `model_code` arguments.
...
- obfuscate_model_name:
  ...
  [`stanc`](https://mc-stan.org/rstan/reference/stanc.md).
