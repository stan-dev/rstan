...
obtained by calling
[`get_stancode`](https://mc-stan.org/rstan/reference/stanfit-class.md).
...
[`stan`](https://mc-stan.org/rstan/reference/stan.md)
...
#> List of 5
#>  $ status       : logi TRUE
#>  $ model_cppname: chr "model1c0045e8ad04_normal1"
...
#>  $ model_code   : chr "data {\n  int<lower=0> N;\n  array[N] real y;\n}\nparameters {\n  real mu;\n}\nmodel {\n  mu ~ normal(0, 10);\n"| __truncated__
#>   ..- attr(*, "model_name2")= chr "file1c00491a6386"
```
