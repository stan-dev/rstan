...
[`monitor`](https://mc-stan.org/rstan/reference/monitor.md) function can
be applied to the returned array to obtain a summary (similar to the
`print` method for
[`stanfit`](https://mc-stan.org/rstan/reference/stanfit-class.md)
objects).
...
and [`monitor`](https://mc-stan.org/rstan/reference/monitor.md)
